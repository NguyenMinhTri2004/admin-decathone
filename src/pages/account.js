...
const Page = () => {
  ...
  const handleSearchByName = (e) => {
    ...
    const tmp = products?.filter((product) => product?.username?.includes(e?.target?.value));
    console.log(tmp);
  ...
  const handleReload = () => {
    getUserByPage(currentPage)
      .then((res) => {
        ...
        setProductSearch(res?.data?.users);
      })
      .catch((err) => {
        console.log(err);
      });
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "15px", width: "100%" }}>
              ...
              <FormControl variant="filled" style={{ width: "20%" }}>
                ...
                >
                  ...
                  <MenuItem value="nhanvienbanhang">Nhân viên</MenuItem>
